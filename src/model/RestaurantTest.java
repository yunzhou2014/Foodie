...
public class RestaurantTest {
	...
	public void testStringToJSONArray() {
		...
		jsonArray.put("American");
		assertTrue(jsonArrayStringEquals(jsonArray, Restaurant.stringToJSONArray(",American")));
		jsonArray.put("");
		assertTrue(jsonArrayStringEquals(jsonArray, Restaurant.stringToJSONArray(",American,")));
		jsonArray.put("Korean");
		assertTrue(jsonArrayStringEquals(jsonArray, Restaurant.stringToJSONArray("American,,Korean,")));
	}
